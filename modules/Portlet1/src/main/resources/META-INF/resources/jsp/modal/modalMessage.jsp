<jsp:useBean id="messageModal" class="java.util.HashMap" scope="request" />
<c:set target="${messageModal}" property="dismiss" value="modal" />

<div class="modal fade" id="messageModal" tabindex="-1" role="dialog"
	style="position: relative" aria-labelledby="popUpLabel"
	aria-hidden="true">
				...
				<aui:form action="${sendEmail}" name="contactProfile"
					...
					<aui:button-row>
						<aui:button type="button" value="portletvass.contactProfile.send"
							data="${popUp}" cssClass="btn btn-primary enviar"></aui:button>
						<aui:button type="button" cssClass="btn btn-danger"
							value="portletvass.contactProfile.cancel" data="${popUp}"></aui:button>
