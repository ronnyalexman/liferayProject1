...
import clienteService.service.ClientesService;
...
/**
 * Provides the base implementation for the clientes remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link clienteService.service.impl.ClientesServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ClientesServiceBaseImpl extends BaseServiceImpl
	implements ClientesService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link clienteService.service.ClientesServiceUtil} to access the clientes remote service.
	 */
	 ...
	 */
	public clienteService.service.ClientesLocalService getClientesLocalService() {
	...
	public void setClientesLocalService(
		clienteService.service.ClientesLocalService clientesLocalService) {
		this.clientesLocalService = clientesLocalService;
	}

	/**
	 * Returns the clientes remote service.
	 *
	 * @return the clientes remote service
	 */
	...
	/**
	 * Sets the clientes remote service.
	 *
	 * @param clientesService the clientes remote service
	 */
	...
	public String getOSGiServiceIdentifier() {
		return ClientesService.class.getName();
	}
	...
	@BeanReference(type = clienteService.service.ClientesLocalService.class)
	protected clienteService.service.ClientesLocalService clientesLocalService;
	@BeanReference(type = ClientesService.class)
