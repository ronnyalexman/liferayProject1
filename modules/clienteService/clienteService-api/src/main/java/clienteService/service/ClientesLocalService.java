...
/**
 * Provides the local service interface for Clientes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ClientesLocalServiceUtil
...
public interface ClientesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClientesLocalServiceUtil} to access the clientes local service. Add custom service methods to {@link clienteService.service.impl.ClientesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
